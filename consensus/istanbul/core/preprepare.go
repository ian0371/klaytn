...
func (c *core) handlePreprepare(msg *message, src istanbul.Validator) error {
	...
	if err := c.checkMessage(msgPreprepare, preprepare.View); err != nil {
		if err == errOldMessage {
			...
			logger.Info("[yum3] CalcProposer from handlePreprepare", "block", preprepare.View.Sequence.Uint64()-1)
			valSet.CalcProposer(previousProposer, preprepare.View.Sequence.Uint64()-1, preprepare.View.Round.Uint64())
