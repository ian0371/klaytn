...
const IRegistryABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"name\",\"type\":\"bytes32\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"SetAddress\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"name\",\"type\":\"bytes32\"}],\"name\":\"getAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"name\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"setAddress\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
func (_IRegistry *IRegistryCaller) GetAddress(opts *bind.CallOpts, name [32]byte) (common.Address, error) {
	ret0 := new(common.Address)
	out := ret0
	err := _IRegistry.contract.Call(opts, out, "getAddress", name)
	return *ret0, err
}
...
//
// Solidity: function getAddress(bytes32 name) view returns(address)
func (_IRegistry *IRegistrySession) GetAddress(name [32]byte) (common.Address, error) {
	return _IRegistry.Contract.GetAddress(&_IRegistry.CallOpts, name)
}

// GetAddress is a free data retrieval call binding the contract method 0x21f8a721.
//
// Solidity: function getAddress(bytes32 name) view returns(address)
func (_IRegistry *IRegistryCallerSession) GetAddress(name [32]byte) (common.Address, error) {
	return _IRegistry.Contract.GetAddress(&_IRegistry.CallOpts, name)
}

// SetAddress is a paid mutator transaction binding the contract method 0xca446dd9.
//
// Solidity: function setAddress(bytes32 name, address addr) returns()
func (_IRegistry *IRegistryTransactor) SetAddress(opts *bind.TransactOpts, name [32]byte, addr common.Address) (*types.Transaction, error) {
	return _IRegistry.contract.Transact(opts, "setAddress", name, addr)
}

// SetAddress is a paid mutator transaction binding the contract method 0xca446dd9.
//
// Solidity: function setAddress(bytes32 name, address addr) returns()
func (_IRegistry *IRegistrySession) SetAddress(name [32]byte, addr common.Address) (*types.Transaction, error) {
	return _IRegistry.Contract.SetAddress(&_IRegistry.TransactOpts, name, addr)
}

// SetAddress is a paid mutator transaction binding the contract method 0xca446dd9.
//
// Solidity: function setAddress(bytes32 name, address addr) returns()
func (_IRegistry *IRegistryTransactorSession) SetAddress(name [32]byte, addr common.Address) (*types.Transaction, error) {
	return _IRegistry.Contract.SetAddress(&_IRegistry.TransactOpts, name, addr)
}

// IRegistrySetAddressIterator is returned from FilterSetAddress and is used to iterate over the raw logs and unpacked data for SetAddress events raised by the IRegistry contract.
type IRegistrySetAddressIterator struct {
	Event *IRegistrySetAddress // Event containing the contract specifics and raw log
...
func (it *IRegistrySetAddressIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IRegistrySetAddress)
...
func (it *IRegistrySetAddressIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IRegistrySetAddressIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IRegistrySetAddress represents a SetAddress event raised by the IRegistry contract.
type IRegistrySetAddress struct {
	Name [32]byte
	Addr common.Address
	Raw  types.Log // Blockchain specific contextual infos
}

// FilterSetAddress is a free log retrieval operation binding the contract event 0x77879ade5d0fc220756fdd6255178c5a1ad8e5ee2ae2970e8b2610242d38d8da.
//
// Solidity: event SetAddress(bytes32 indexed name, address addr)
func (_IRegistry *IRegistryFilterer) FilterSetAddress(opts *bind.FilterOpts, name [][32]byte) (*IRegistrySetAddressIterator, error) {
	var nameRule []interface{}
	for _, nameItem := range name {
		nameRule = append(nameRule, nameItem)
	}

	logs, sub, err := _IRegistry.contract.FilterLogs(opts, "SetAddress", nameRule)
	if err != nil {
		return nil, err
	}
	return &IRegistrySetAddressIterator{contract: _IRegistry.contract, event: "SetAddress", logs: logs, sub: sub}, nil
}

// WatchSetAddress is a free log subscription operation binding the contract event 0x77879ade5d0fc220756fdd6255178c5a1ad8e5ee2ae2970e8b2610242d38d8da.
//
// Solidity: event SetAddress(bytes32 indexed name, address addr)
func (_IRegistry *IRegistryFilterer) WatchSetAddress(opts *bind.WatchOpts, sink chan<- *IRegistrySetAddress, name [][32]byte) (event.Subscription, error) {
	var nameRule []interface{}
	for _, nameItem := range name {
		nameRule = append(nameRule, nameItem)
	}

	logs, sub, err := _IRegistry.contract.WatchLogs(opts, "SetAddress", nameRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IRegistrySetAddress)
				if err := _IRegistry.contract.UnpackLog(event, "SetAddress", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseSetAddress is a log parse operation binding the contract event 0x77879ade5d0fc220756fdd6255178c5a1ad8e5ee2ae2970e8b2610242d38d8da.
//
// Solidity: event SetAddress(bytes32 indexed name, address addr)
func (_IRegistry *IRegistryFilterer) ParseSetAddress(log types.Log) (*IRegistrySetAddress, error) {
	event := new(IRegistrySetAddress)
	if err := _IRegistry.contract.UnpackLog(event, "SetAddress", log); err != nil {
		return nil, err
	}
...
const RegistryABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"name\",\"type\":\"bytes32\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"SetAddress\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"name\",\"type\":\"bytes32\"}],\"name\":\"getAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"name\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"setAddress\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"

// RegistryBinRuntime is the compiled bytecode used for adding genesis block without deploying code.
const RegistryBinRuntime = ``
...
var RegistryBin = ""
...
//
// Solidity: function getAddress(bytes32 name) view returns(address)
func (_Registry *RegistryCaller) GetAddress(opts *bind.CallOpts, name [32]byte) (common.Address, error) {
	ret0 := new(common.Address)
	out := ret0
	err := _Registry.contract.Call(opts, out, "getAddress", name)
	return *ret0, err
}
...
//
// Solidity: function getAddress(bytes32 name) view returns(address)
func (_Registry *RegistrySession) GetAddress(name [32]byte) (common.Address, error) {
	return _Registry.Contract.GetAddress(&_Registry.CallOpts, name)
}

// GetAddress is a free data retrieval call binding the contract method 0x21f8a721.
//
// Solidity: function getAddress(bytes32 name) view returns(address)
func (_Registry *RegistryCallerSession) GetAddress(name [32]byte) (common.Address, error) {
	return _Registry.Contract.GetAddress(&_Registry.CallOpts, name)
}
...
//
// Solidity: function setAddress(bytes32 name, address addr) returns()
func (_Registry *RegistryTransactor) SetAddress(opts *bind.TransactOpts, name [32]byte, addr common.Address) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "setAddress", name, addr)
}

// SetAddress is a paid mutator transaction binding the contract method 0xca446dd9.
//
// Solidity: function setAddress(bytes32 name, address addr) returns()
func (_Registry *RegistrySession) SetAddress(name [32]byte, addr common.Address) (*types.Transaction, error) {
	return _Registry.Contract.SetAddress(&_Registry.TransactOpts, name, addr)
}

// SetAddress is a paid mutator transaction binding the contract method 0xca446dd9.
//
// Solidity: function setAddress(bytes32 name, address addr) returns()
func (_Registry *RegistryTransactorSession) SetAddress(name [32]byte, addr common.Address) (*types.Transaction, error) {
	return _Registry.Contract.SetAddress(&_Registry.TransactOpts, name, addr)
}
...
// RegistrySetAddressIterator is returned from FilterSetAddress and is used to iterate over the raw logs and unpacked data for SetAddress events raised by the Registry contract.
type RegistrySetAddressIterator struct {
	Event *RegistrySetAddress // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *RegistrySetAddressIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(RegistrySetAddress)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *RegistrySetAddressIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *RegistrySetAddressIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// RegistrySetAddress represents a SetAddress event raised by the Registry contract.
type RegistrySetAddress struct {
	Name [32]byte
	Addr common.Address
	Raw  types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event SetAddress(bytes32 indexed name, address addr)
func (_Registry *RegistryFilterer) FilterSetAddress(opts *bind.FilterOpts, name [][32]byte) (*RegistrySetAddressIterator, error) {
	var nameRule []interface{}
	for _, nameItem := range name {
		nameRule = append(nameRule, nameItem)
	}

	logs, sub, err := _Registry.contract.FilterLogs(opts, "SetAddress", nameRule)
	if err != nil {
		return nil, err
	}
	return &RegistrySetAddressIterator{contract: _Registry.contract, event: "SetAddress", logs: logs, sub: sub}, nil
}

// WatchSetAddress is a free log subscription operation binding the contract event 0x77879ade5d0fc220756fdd6255178c5a1ad8e5ee2ae2970e8b2610242d38d8da.
//
// Solidity: event SetAddress(bytes32 indexed name, address addr)
func (_Registry *RegistryFilterer) WatchSetAddress(opts *bind.WatchOpts, sink chan<- *RegistrySetAddress, name [][32]byte) (event.Subscription, error) {
	var nameRule []interface{}
	for _, nameItem := range name {
		nameRule = append(nameRule, nameItem)
	}

	logs, sub, err := _Registry.contract.WatchLogs(opts, "SetAddress", nameRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(RegistrySetAddress)
				if err := _Registry.contract.UnpackLog(event, "SetAddress", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetAddress(bytes32 indexed name, address addr)
func (_Registry *RegistryFilterer) ParseSetAddress(log types.Log) (*RegistrySetAddress, error) {
	event := new(RegistrySetAddress)
	if err := _Registry.contract.UnpackLog(event, "SetAddress", log); err != nil {
		return nil, err
	}
